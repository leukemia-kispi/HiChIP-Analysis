...
Detailed Instructions for Dovetail HiChIP
...
```
sudo apt update
sudo apt upgrade -y  #Automatically confirm upgrades
```

**Install Anaconda3 to set up Conda environments and access Conda archives**
```
sudo apt install curl -y #tool for transferring data from or to a server using URLs
curl -O https://repo.anaconda.com/archive/Anaconda3-2022.10-Linux-x86_64.sh #download the bash file for installation
sha256sum Anaconda3-2022.10-Linux-x86_64.sh  # Verify the checksum 
```
The expected checksum: e7ecbccbc197ebd7e1f211c59df2e37bc6959d081f2235d387e08c9026666acd or use the appropriate one from https://repo.anaconda.com/archive/
